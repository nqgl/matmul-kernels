...
@triton.autotune(
    configs=[
        ...
        triton.Config({'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 128, 'GROUP_SIZE_M' : 8}, num_stages=2,num_warps=4),
        ...
        triton.Config({'BLOCK_SIZE_M': 32, 'BLOCK_SIZE_N': 64, 'BLOCK_SIZE_K': 64, 'GROUP_SIZE_M' : 8}, num_stages=2,num_warps=4),
        triton.Config({'BLOCK_SIZE_M': 64, 'BLOCK_SIZE_N': 32, 'BLOCK_SIZE_K': 64, 'GROUP_SIZE_M' : 8}, num_stages=2,num_warps=4),
...
def matmul_basic_kernel(
    ...
    pid_per_group = GROUP_SIZE_M * n_Nblocks # so each group does 
                                                # M // group_size_m of M
                                                # and 1 of N ?
